...
* Scripts and style sheets get minified and bundled together to avoid extra network requests.
...
Normally we recommend importing [style sheets](#adding-a-stylesheet), [images, and fonts](#adding-images-fonts-and-files) from JavaScript.
