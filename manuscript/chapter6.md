...
T> If you continue to encounter issues, please refer to the book's [source code](https://github.com/FarhadG/ui-react) to inspect the versions of the dependencies and the Webpack configuration used.
...
{title=src/styles/theme.scss, lang=text}
```
$APP: 'todos-app';
...
{title=src/styles/globals.scss, lang=text}
```
html {
...
{title=src/styles/main.scss, lang=text}
```
@import "theme.scss";
@import "globals.scss";
```
...
{title=src/components/App/App.scss, lang=text}
```
@import '../../styles/theme';
...
{title=src/components/TodosList/TodosList.scss, lang=text}
```
@import '../../styles/theme';
...
{title=src/components/TodosListItem/TodosListItem.scss, lang=text}
```
@import '../../styles/theme';
...
I> CSS preprocessors, like Sass, have many useful operators that can make working with colors a breeze. Be sure to leverage them in your projects.
...
{src=src/components/TodosListInfo/TodosListInfo.js, lang=text}
```
// dependencies
...
{src=src/components/TodosListInfo/TodosListInfo.scss, lang=text}
```
@import '../../styles/theme';
